...
const SAMPLE: Product[] = [
  {
    id: 6668, code: 'KST045S21UC', image: '', productState: 'prod', name: 'Tabouret LOU monochrome Wave x Uchronia',
    ...
    variants: [
      { id: 97040, sku: 'KST045S21UC126', attr: 'ice cream beige', color: '#ecdcc0', state: 'prod', barcode: '3701499936173', price: 157.5, cost: 43.69, weight: 1, volume: 0, dimVariant: '450×300×300mm', hsVariant: '94014100', origin: 'Bulgaria', diameter: 'Ø300mm', dimPacked: '600×360×90mm', flatpack: 'yes', spidy: 'F0', pricePublic: 165.83, priceWholesale: 94.53, priceUsd: 320 },
      { id: 97041, sku: 'KST045S21UC226', attr: 'chocolate brown', color: '#5a3a26', state: 'prod', barcode: '3701499936180', price: 157.5, cost: 43.69, weight: 1, volume: 0, dimVariant: '450×300×300mm', hsVariant: '94014100', origin: 'Bulgaria', diameter: 'Ø300mm', dimPacked: '600×360×90mm', flatpack: 'yes', spidy: 'F0', pricePublic: 165.83, priceWholesale: 94.53, priceUsd: 320 },
      { id: 97042, sku: 'KST045S21UC526', attr: 'astral purple', color: '#5b4a86', state: 'prod', barcode: '3701499936159', price: 157.5, cost: 43.69, weight: 1, volume: 0, dimVariant: '450×300×300mm', hsVariant: '94014100', origin: 'Bulgaria', diameter: 'Ø300mm', dimPacked: '600×360×90mm', flatpack: 'yes', spidy: 'F0', pricePublic: 165.83, priceWholesale: 94.53, priceUsd: 320 },
      { id: 97043, sku: 'KST045S21UC826', attr: 'magma orange', color: '#d4691f', state: 'prod', barcode: '3701499936166', price: 157.5, cost: 43.69, weight: 1, volume: 0, dimVariant: '450×300×300mm', hsVariant: '94014100', origin: 'Bulgaria', diameter: 'Ø300mm', dimPacked: '600×360×90mm', flatpack: 'yes', spidy: 'F0', pricePublic: 165.83, priceWholesale: 94.53, priceUsd: 320 },
    ],
  },
];
